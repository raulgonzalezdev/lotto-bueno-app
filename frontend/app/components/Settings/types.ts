...
export interface SettingsConfiguration {
  ...
  Chat: ChatSettings;
  EnvVariables: EnvVariablesSettings;
}

// Setting Options

export interface EnvVariablesSettings extends MetaInformation {
  settings: {
      NEXT_PUBLIC_SITE_TITLE: TextFieldSetting;
      NEXT_PUBLIC_SITE_DESCRIPTION: TextFieldSetting;
      NEXT_PUBLIC_FAVICON_URL: TextFieldSetting;
      NEXT_PUBLIC_CHAT_INTERFACE_INFO: TextFieldSetting;
      NEXT_PUBLIC_DOCUMENT_INTERFACE_INFO: TextFieldSetting;
      NEXT_PUBLIC_CHUNK_INTERFACE_INFO: TextFieldSetting;
  };
}
